...
void main() => runApp(Tafser());

class Tafser extends StatefulWidget {
  @override
  _TafserState createState() => _TafserState();
}

class _TafserState extends State<Tafser>  with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    getFileFromAsset("assets/serin.pdf").then((f) {
      setState(() {
        assetPDFPath = f.path;
        print(assetPDFPath);
      });
  ...
  Future<File> getFileFromAsset(String asset) async {
    try {
      ...
      File file = File("${dir.path}/serin.pdf");
...
class _webviewState extends State<webview> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
          initialUrl: "http://www.marqoom.org/dics/dreams",
